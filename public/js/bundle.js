      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 11:
            ...
            console.log('There was an error💥💥💥', _context.t0); // console.log(error.response);
...
var stripe = Stripe('pk_test_51J7DyBLL5gBuIClF0GhWIreyaHriKDeZbxqZuI52LF4ZnyhfgbtZXkRIUPwZOLcJAUCz6k8HGKgAUpK1wXre4pp300lssYt9WM');
...
console.log('Hello from index.js'); // DOM ELEMENTS
